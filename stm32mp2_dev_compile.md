...
```bash
cd stm32mp2-openstlinux-6.6-yocto-scarthgap-mpu-v24.12.05/images/stm32mp1
...
tar xvf en.SDK-x86_64-stm32mp2-openstlinux-6.6-yocto-scarthgap-mpu-v24.11.06.tar.gz
mkdir -p ~/stmpu/ostl6.0/sdk2
mkdir -p ~/stmpu/ostl6.0/src

cp -r cp -r stm32mp2-openstlinux-6.6-yocto-scarthgap-mpu-v24.11.06/sources/aarch64-ostl-linux/linux-stm32mp-6.6.48-stm32mp-r1-r0/*  ~/stmpu/ostl6.0/src/

chmod +x stm32mp2-openstlinux-6.6-yocto-scarthgap-mpu-v24.11.06/sdk/st-image-weston-openstlinux-weston-stm32mp2.rootfs-x86_64-toolchain-5.0.3-openstlinux-6.6-yocto-scarthgap-mpu-v24.11.06.sh

yes | stm32mp2-openstlinux-6.6-yocto-scarthgap-mpu-v24.11.06/sdk/st-image-weston-openstlinux-weston-stm32mp2.rootfs-x86_64-toolchain-5.0.3-openstlinux-6.6-yocto-scarthgap-mpu-v24.11.06.sh -d ~/stmpu/ostl6.0/sdk2/

rm -r stm32mp2-openstlinux-6.6-yocto-scarthgap-mpu-v24.11.06

echo 
echo "Linux sources are installed in ~/stmpu/ostl6.0/src"
echo
echo "SDK is installed in ~/stmpu/ostl6.0/sdk, you can run it using activate it using following command"
echo "source ~/stmpu/ostl6.0/sdk/environment-setup-cortexa7t2hf-neon-vfpv4-ostl-linux-gnueabi"
echo 
```
